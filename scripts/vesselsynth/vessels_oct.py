...
class VesselSynth(object):
    ...
    def __init__(self):
        ...
        self.json_params = json.load(open("scripts/vesselsynth/vesselsynth_params.json"))   # This is the json file that should be one directory above this one. Defines all variables
    ...
    def synth(self):
        try:
            import glob
            [os.remove(x) for x in glob.glob(f"{self.root}/*")]
        except:
            pass
